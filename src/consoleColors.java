...
*/
        ...
        */
        ...
        public static final String ANSI_BROWN = "\\e[0;33m";
        ...
        public consoleColors printTxtBackgroung(String txt) {
            txtToPrint.append(ANSI_WHITE_BACKGROUND + txt + ANSI_RESET);
            return this;
        }

        public consoleColors printTxtBold(String txt) {
            txtToPrint.append(ANSI_BOLD + txt + ANSI_RESET);
            return this;
        }

        public consoleColors printTxtUnbold(String txt) {
            txtToPrint.append(ANSI_UNBOLD + txt + ANSI_RESET);
            return this;
        }
        public consoleColors printTxtCyan(String txt) {
            txtToPrint.append(ANSI_CYAN + txt + ANSI_RESET);
            return this;
        }
}
